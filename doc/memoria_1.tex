...
\input{secciones/1_preprocesado}
\input{secciones/2_k-nn}
\input{secciones/3_busqueda_local}
\input{secciones/4_greedy}
\include{secciones/5_conclusiones}
\include{secciones/6_estructura}
