...
\input{secciones/0_problema}
\chapter{Práctica 1: Técnicas de Búsqueda Local 
y 
Algoritmos Greedy}
\input{secciones/P1/1_preprocesado}
\input{secciones/P1/2_k-nn}
\input{secciones/P1/3_busqueda_local}
\input{secciones/P1/4_greedy}
\include{secciones/P1/5_conclusiones}
\include{secciones/P1/6_estructura}
% Práctica 2: 
\chapter{Práctica 2: Técnicas de Búsqueda basadas en Poblaciones}

% Pseudo código de los AGs y los operadores de cruce y mutación.
\input{secciones/P2/1_AGG}
\input{secciones/P2/2_Operadores_cruce} 
\input{secciones/P2/3_Resultados_algoritmos_geneticos}
% algoritmo memético 
\include{secciones/P2/4_Algoritmo_memetico}
\input{secciones/P2/5_Resultados_algoritmos_memeticos}
\include{secciones/P2/6_Resultados_finales_p2}

% Práctica 3
\chapter{Práctica 3: Búsquedas por trayectorias}
\include{secciones/P3/1_Enfriamiento_simulado}
\include{secciones/P3/2_BMB}
\include{secciones/P3/3_ILS}
\include{secciones/P3/4_conclusiones}
