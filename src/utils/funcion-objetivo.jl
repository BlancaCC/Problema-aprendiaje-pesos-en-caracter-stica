...
"""
CrearFuncionObjetivoVerbose(datos, etiquetas, a, umbral_tasa_reduccion::Real)
...
"""
function CrearFuncionObjetivoVerbose(datos, etiquetas, a::Real, umbral_tasa_reduccion::Real)
    ...
    function FuncionObjetivo(w::Vector{<:Real})::Real
        ...
        # Evaluación combinación de ambas
        return a*accuracy + (1-a)*tasa_reducion, accuracy, tasa_reducion
    end
